...
#Are you going to include the ethnicity data in later plots? If not, you could just select the other columns. 
```
...
#This table is helpful and conveys a lot of information in a very clear format. 
```
...
#You could use this same plot and facet wrap by ethnicity instead of gender. 
```
